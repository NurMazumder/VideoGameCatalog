...
router.post(
    ...
    async (req, res) => {
      ...
      try {
        ...
        const { description, name, backgroundImage, rawgId, released, website, rating, ratingsCount, platforms, developers, publishers, genres, tags } = req.body;
...
router.get('/:id', async (req, res) => {
    try {
      ...
      const videoGame = await VideoGame.findById(req.params.id).populate('reviews');
      if (!videoGame) {
